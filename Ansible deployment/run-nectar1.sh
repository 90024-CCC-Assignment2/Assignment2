...
#
# Location: Melbourne
# . ./unimelb-comp90024-2022-grp-42-openrc.sh; ansible-playbook -i hosts bootstrap_infrastructure.yaml

. ./unimelb-comp90024-2022-grp-42-openrc.sh; ansible-playbook -i hosts nectar1.yaml